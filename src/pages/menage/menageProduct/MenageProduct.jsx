            ...
            <table class="min-w-full divide-y divide-black-500 m-5">
              ...
              <tbody class="bg-white divide-y divide-gray-500">
                {product &&
                  product.map((val, key) => (
                    <tr key={key}>
                      <td class="px-6 py-4 whitespace-nowrap">{val.product}</td>
                      ...
                      <td class="px-6 py-4 whitespace-nowrap">
                        <button onClick={() => navigate(`/addproduct/${val.id}`)} class="px-4 py-2 font-medium text-white bg-blue-600 rounded-md hover:bg-blue-500 focus:outline-none focus:shadow-outline-blue active:bg-blue-600 transition duration-150 ease-in-out">
                          Edit
                        </button>
